...
QLabel* createQuickAccessCard(const QString& title, const QString& percentage, const QString& timeRemaining) {
...
void DashboardWindow::setupLeftSidebar()
{
    ...
    QDockWidget *sidebarDock = new QDockWidget("hhhhh", this);
