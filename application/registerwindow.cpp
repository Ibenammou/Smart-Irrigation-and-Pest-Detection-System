...
QWidget* RegisterWindow::createPage1() {
    ...
    emailLabel->setStyleSheet("color: white; font-size: 16px;");
    phoneLabel->setStyleSheet("color: white; font-size: 16px;");
    locationLabel->setStyleSheet("color: white; font-size: 16px;");
...
QWidget* RegisterWindow::createPage2() {
    ...
    cropTypeLabel->setStyleSheet("color: white; font-size: 16px;");
    areaLabel->setStyleSheet("color: white; font-size: 16px;");
    soilTypeLabel->setStyleSheet("color: white; font-size: 16px;");
    plantDateLabel->setStyleSheet("color: white; font-size: 16px;");
...
QWidget* RegisterWindow::createPage3() {
    ...
    waterNeedsLabel->setStyleSheet("color: white; font-size: 16px;");
    sunlightNeedsLabel->setStyleSheet("color: white; font-size: 16px;");
    irrigationFreqLabel->setStyleSheet("color: white; font-size: 16px;");
    irrigationTypeLabel->setStyleSheet("color: white; font-size: 16px;");
...
QWidget* RegisterWindow::createPage4() {
    ...
    climateConditionLabel->setStyleSheet("color: white; font-size: 16px;");
    budgetLabel->setStyleSheet("color: white; font-size: 16px;");
    notificationFreqLabel->setStyleSheet("color: white; font-size: 16px;");
...
QWidget* RegisterWindow::createPage5() {
    ...
    uploadButton->setStyleSheet("background-color: #4CAF50; color: white; font-size: 16px; padding: 5px;");
    registerButton->setStyleSheet("background-color: #4CAF50; color: white; font-size: 16px; padding: 5px;");
